...
public class RNABPushNotificationAttributes {
    ...
    public RNABPushNotificationAttributes(Bundle bundle) {
    ...
    private RNABPushNotificationAttributes(JSONObject jsonObject) {
        try {
    ...
    @NonNull
    public static RNABPushNotificationAttributes fromJson(String notificationAttributesJson) throws JSONException {
        JSONObject jsonObject = new JSONObject(notificationAttributesJson);
        return new RNABPushNotificationAttributes(jsonObject);
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            Log.e("RNABPushNotificationAttributes", "Exception while converting RNPushNotificationAttributes to " +
