...
import static com.reactlibrary.modules.RNABPushNotificationAttributes.fromJson;

public class RNABPushNotificationHelper {
    public static final String PREFERENCES_KEY = "rn_baidu_push_notification";
    private static final long DEFAULT_VIBRATION = 300L;
    private static final String LOG_TAG = "RNABPushNotificationHelper";
    ...
    public RNABPushNotificationHelper(Application context) {
        ...
        this.scheduledNotificationsPersistence = context.getSharedPreferences(RNABPushNotificationHelper.PREFERENCES_KEY, Context.MODE_PRIVATE);
    }
    ...
    private PendingIntent toScheduleNotificationIntent(Bundle bundle) {
        ...
        Intent notificationIntent = new Intent(context, RNABPushNotificationPublisher.class);
        notificationIntent.putExtra(RNABPushNotificationPublisher.NOTIFICATION_ID, notificationID);
    ...
    public void sendNotificationScheduled(Bundle bundle) {
        ...
        RNABPushNotificationAttributes notificationAttributes = new RNABPushNotificationAttributes(bundle);
        ...
        for (String id : scheduledNotificationsPersistence.getAll().keySet()) {
            try {
                ...
                if (notificationAttributesJson != null) {
                    RNABPushNotificationAttributes notificationAttributes = fromJson(notificationAttributesJson);
